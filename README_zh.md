...
---
请务必升级到最新版(9.0.3 或者 8.5.15)，因为 confluence 的这个 [bug](https://confluence.atlassian.com/security/cve-2023-22518-improper-authorization-vulnerability-in-confluence-data-center-and-server-1311473907.html).
...
+ 最新版本(arm64&amd64): v8(8.9.6) v9(9.0.3)
+ 长期维护的版本(arm64&amd64): v8(8.5.15)
